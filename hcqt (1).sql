...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 21, 2016 at 05:00 AM
...
CREATE TABLE `anhhoatdong` (
  `ID` int(11) NOT NULL,
  `DuongDan` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `to` (
  `MaTo` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `TenTo` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
('HCQT', 'Tổ Hành chính - Quản trị'),
('TaiVu', 'Tổ Kế hoạch - Tài Chính');
