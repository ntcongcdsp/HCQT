	...
	<div class="col-xs-12">
		<div class="panel panel-primary">
    		<div class="panel-heading" style="text-align: center; font-family: time new roman; font-size:17px;">
            	<b>XEM LẠI THÔNG TIN THÍ SINH ĐĂNG KÝ XÉT TUYỂN</b>          
	        </div>
    	    <div class="panel-body">
				<div class="row" style="position:relative;right:20px;">
                    ...
                    <div class="form-group" align="center">
                        <button type="submit" class="btn btn-success" id="submit_DangNhap" name="submit_DangNhap" style="margin-right:10px">Đăng nhập</button>
